...
export function createCylinderMenu(scene) {
    ...
    properties.forEach((property) => {
        ...
        if (property === 'Radial Segments') {
            ...
            input.value = 20; // Default radial segments
    ...
    addButton.textContent = 'Add Cylinder';
    ...
    addButton.addEventListener('click', () => {
        ...
        const cylinder = createCylinder({ position, rotation, scale, color, radialSegments });
        addObject(scene, cylinder);
    });
